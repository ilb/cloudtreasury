...
export default function Offer() {
  const { /** @type {CalculationResource} */ calculationResource } =
      ...
      <Card>
        <ReportTable
          ...
          onChangeParams={(params) =>
            calculationResource.getCalculationsData(params)
          }
          onExport={(params) =>
            window.open(
              `api/calculations/export?${new URLSearchParams(
                params
              ).toString()}`
            )
          }
